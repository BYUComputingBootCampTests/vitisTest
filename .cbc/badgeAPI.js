...
var vitisBadgeEntityID = 'Insert new ID here!';
...
issueAssertionToTestUser(computingBootCampId, vitisBadgeEntityID, userEmail, accessToken);
...
Forked Repository";
    else console.log("Success! vitis Badge has been issued to" + userEmail);
    //return JSON.parse(xhr.responseText);
}